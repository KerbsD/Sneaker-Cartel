...
function Cart() { 
   ...
   useEffect(() => {
    ...
    return (
        <div className="">
            {
                <p className={notif ? "text-stone-100 px-4 py-1 border-2 border-red-700 bg-red-400 rounded-lg font-bold text-center w-[150px] left-35 duration-300 absolute h-8" : " w-[150px] left-35 duration-300 absolute h-0"}>{notif}</p>
            }
